...
class JobManager:
    ...
    def _serialize_dict(self, data: Any) -> Any:
        ...
        if hasattr(data, 'dict'):
            ...
            return {
                key: self._serialize_dict(value)
    ...
    def create_job(self, db: Session, url: str, operation: str = 'scrape', formats: list = None, page_options: dict = None) -> str:
        job_id = str(uuid4())
    ...
    def update_job(self,db: Session, job_id: str, status: str, result: Optional[Any] = None, error: Optional[str] = None):
        try:
